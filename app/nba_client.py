...
class BallDontLieClient:
    ...
    def __init__(self, base_url: str | None = None, timeout: int = 15) -> None:
        ...
        if api_key:
            ...
            self.session.headers["Authorization"] = auth_value
    ...
    def _get(self, path: str, params: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 401:
                raise NBAApiError(
                    "401 Unauthorized from balldontlie API. "
                    "Set BALLDONTLIE_API_KEY correctly and use a valid Authorization header."
                )
